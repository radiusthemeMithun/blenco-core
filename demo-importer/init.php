 ...
 *
 * @package RT\BLENCO\DemoImporter
 */
...
if ( ! defined( 'RT_BLENCO_DEMO_IMPORTER_PATH' ) ) {
	define( 'RT_BLENCO_DEMO_IMPORTER_PATH', __DIR__ );
}

if ( ! defined( 'RT_BLENCO_DEMO_IMPORTER_URL' ) ) {
	define( 'RT_BLENCO_DEMO_IMPORTER_URL', plugin_dir_url( __FILE__ ) );
}
...
spl_autoload_register(
	function ( $class ) {
		$namespaces = [
			'RT\\BLENCO\\DemoImporter\\' => __DIR__ . '/src/',
		];
...
$demo_config = array_merge(
	[
		...
		'core_base_dir'    => BLENCO_CORE_BASE_DIR,
		'demo_content_dir' => RT_BLENCO_DEMO_IMPORTER_PATH,
		'demo_content_url' => RT_BLENCO_DEMO_IMPORTER_URL,
	],
	$demo_config
);
...
try {
	new RT\BLENCO\DemoImporter\Core( $demo_config );
} catch ( Exception $e ) {
