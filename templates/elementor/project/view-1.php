...
<div class="rt-project-default rt-project-multi-layout-default project-grid-<?php echo esc_attr( $layout );?>" 
     data-rt-animate="<?php echo esc_attr( $enable_scroll_animation ); ?>">
	<div class="row <?php echo esc_attr( $item_space );?>">
		<?php $ade = $delay; $adu = $duration; if ( $query->have_posts() ) {
			...
			while ( $query->have_posts() ) {
				...
				?>
                <div class="<?php echo esc_attr( $col_class );?> <?php echo esc_attr( $item_parity  );?> <?php echo esc_attr( $animation );?> <?php echo esc_attr( $animation_effect );?>" data-wow-delay="<?php echo esc_attr( $ade );?>ms" data-wow-duration="<?php echo esc_attr( $adu );?>ms">
