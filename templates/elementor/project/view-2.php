...
if ( !empty( $cat_id ) && $query_type == 'category' ) {
	$args['tax_query'] = [
		[
...
if ( !empty( $post_id ) && $query_type == 'posts' ) {
	$args['post__in'] = $post_id;
}

$thumb_size = $project_thumbnail_size ? $project_thumbnail_size : 'full';
			...
			while ( $query->have_posts() ) {
				...
				<div class="<?php echo esc_attr( $col_class );?> <?php echo esc_attr( $animation );?> <?php echo esc_attr( $animation_effect );?>" data-wow-delay="<?php echo esc_attr( $ade );?>ms" data-wow-duration="<?php echo esc_attr( $adu );?>ms">
					<div class="project-item">
						<div class="project-thumbs <?php echo empty( $button_display ) ? 'shape-hidden' : ''; ?> <?php echo esc_attr( $grayscale_display );?>">
						...
						<div class="project-content">
							<div class="project-info">
									...
									<span class="project-cat">
										...
										if ( $term_lists ) {
											foreach ( $term_lists as $term_list ) {
												...
												?><a href="<?php echo esc_url( $link ); ?>"><?php echo esc_html( $term_list->name ); ?></a><?php
												$i++;
											}
										}
										?>
								...
								<<?php echo esc_attr( $title_tag ); ?> class="project-title">
