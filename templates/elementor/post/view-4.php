                ...
                <div class="rt-post-meta">
                    <ul class="entry-meta">
						<?php if ( $author_visibility ) { ?>
                            <li><i class="icon-rt-user-1"></i><?php echo blenco_posted_by(esc_html__( 'by ', 'blenco-core' )); ?></li>
						<?php } if ( $date_visibility ) { ?>
                            <li><i class="icon-rt-calender-4"></i><?php echo blenco_posted_on(); ?></li>
						<?php } if ( $cat_visibility && empty( has_post_thumbnail() ) ) { ?>
                            <li><i class="icon-rt-calender-4"></i><?php echo blenco_posted_in(); ?></li>
						...
						<?php } if ( $reading_visibility ) { ?>
                            <li><i class="icon-rt-clock"></i><?php echo blenco_reading_time(); ?></li>
