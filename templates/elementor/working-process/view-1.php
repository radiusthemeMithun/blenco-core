        ...
        foreach($process_list as $item) {
            ...
            <div class="<?php echo esc_attr( $col_class );?>">
                <div class="process-item <?php if( !empty( $alignment ) ) { ?><?php echo esc_attr( $alignment );?><?php } ?> elementor-repeater-item-<?php echo esc_attr($item['_id']) ?> <?php echo esc_attr( $animation );?> <?php echo esc_attr( $animation_effect );?>" data-wow-delay="<?php echo esc_attr( $ade );?>ms" data-wow-duration="<?php echo esc_attr( $adu );?>ms">
	                <?php if( $step_display == 'yes' || $number_display == 'yes' ) { ?>
                    <div class="process-info">
	                    <?php if( $step_display == 'yes' ) { ?><div class="rt-step"><?php echo blenco_html( $item['step'], 'allow_title' );?></div><?php } ?>
	                    <?php if( $number_display == 'yes' ) { ?><div class="rt-number"><?php echo blenco_html( $item['number'], 'allow_title' );?></div><?php } ?>
                    </div>
	                <?php } ?>
                    <div class="process-content">
	                    <?php if( $item['title'] ) { ?><<?php echo esc_attr( $title_tag ) ?> class="rt-title"><a class="title-link" <?php echo $attr; ?>><?php echo blenco_html( $item['title'], 'allow_title' );?></a></<?php echo esc_attr( $title_tag ) ?>><?php } ?>
