...
$pin_class = ( ! empty( $pin_animation ) && 'yes' === $pin_animation ) ? 'rt-panel-pin' : '';

?>


<div class="rt-info-box rt-info-<?php echo esc_attr( $layout ) ?> <?php echo esc_attr( $pin_class ); ?>" data-parallax='{"<?php echo esc_attr( $x_range );?>" : <?php echo esc_attr( $range_one );?>, "<?php echo esc_attr( $y_range );?>" : <?php echo esc_attr( $range_two );?>}'>
        ...
        <div class="info-content">
            <?php if( $image_icon['id'] || $info_icon ) { ?>
                <div class="info-icon-holder icon-holder">
                    ...
                    <?php if ( $title ) { ?>
                        <<?php echo esc_attr( $title_tag ); ?> class="info-title"><a <?php echo $attr; ?>><?php blenco_html( $title, 'allow_title' );?></a></<?php echo esc_attr( $title_tag ); ?>>
                    <?php } ?>
                </div>
            <?php } ?>
            ...
            <div class="info-content-holder">
                <?php if ( $sub_title ) : ?>
                    <div class="content-holder"><p><?php blenco_html( $sub_title, 'allow_title' );?></p></div>
                <?php endif; ?>
