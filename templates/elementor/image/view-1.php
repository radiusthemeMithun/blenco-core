...
$rotate_animation = ( $image_rotate_animation == 'yes' ) ? 'rt-image-rotate' : '';
...
<div class="rt-image-layout rt-image-<?php echo esc_attr( $layout ) ?> <?php if( !empty( $alignment ) ) { ?><?php echo esc_attr( $alignment ) ?><?php } ?>">
    ...
    <?php if( $layout == 'layout-3' ) { ?>
        <div class="rt-image fade-animation">     
            <?php 
    ...
    <?php if( $layout == 'layout-4' ) { ?>
        <div class="rt-image">
            <div class="fade-animation" data-direction="top" data-ease="bounce" data-offset="100">
	            <?php if( $attr ) : ?>
                <a <?php echo esc_attr($attr) ?> aria-label="image">
		            <?php endif ?>
                        <?php echo wp_get_attachment_image( $main_image['id'], 'full' ); ?>
    ...
    <?php } ?>
    <?php if( $layout == 'layout-5' ) { ?>
        <div class="rt-image">
            <div class="<?php echo esc_attr( $rotate_animation); ?>">
	            <?php if( $attr ) : ?>
                <a <?php echo esc_attr($attr) ?> aria-label="image">
		            <?php endif ?>
		            <?php echo wp_get_attachment_image( $main_image['id'], 'full' ); ?>
