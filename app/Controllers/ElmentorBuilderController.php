...
class ElmentorBuilderController {
	...
	public static $post_type = 'elementor-blenco';
	...
	public function __construct() {
		...
		//add_action( "save_post_{self::$post_type}", [ $this, 'save_el_blenco' ] );
	...
	public function header_footer_posttype() {
		$labels = [
			'name'               => __( 'Header & Footer Builder', 'blenco-core' ),
			'singular_name'      => __( 'Header & Footer Builder', 'blenco-core' ),
			'menu_name'          => __( 'Header & Footer Builder', 'blenco-core' ),
			'name_admin_bar'     => __( 'Header & Footer Builder', 'blenco-core' ),
			'add_new'            => __( 'Add New', 'blenco-core' ),
			'add_new_item'       => __( 'Add New Header or Footer', 'blenco-core' ),
			'new_item'           => __( 'New Template', 'blenco-core' ),
			'edit_item'          => __( 'Edit Template', 'blenco-core' ),
			'view_item'          => __( 'View Template', 'blenco-core' ),
			'all_items'          => __( 'All Templates', 'blenco-core' ),
			'search_items'       => __( 'Search Templates', 'blenco-core' ),
			'parent_item_colon'  => __( 'Parent Templates:', 'blenco-core' ),
			'not_found'          => __( 'No Templates found.', 'blenco-core' ),
			'not_found_in_trash' => __( 'No Templates found in Trash.', 'blenco-core' ),
		];
	...
	public function save_el_blenco( $post_id ) {
	...
	public function override_header() {
		require BLENCO_CORE_BASE_DIR . 'templates/builder/header.php';
		$templates   = [];
	...
	public function override_footer() {
		require BLENCO_CORE_BASE_DIR . 'templates/builder/footer.php';
		$templates   = [];
	...
	function hfe_render_header() {
		if ( false == apply_filters( 'blenco_header_builder_enable', true ) ) {
			return;
		}

		?>

        <header id="masthead" class="site-header headroom blenco-header-builder" role="banner">
        ...
        <div id="header-search" class="header-search">
            <div class="header-search-wrap">
                ...
                <form method="get" class="header-search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                    <input type="search" value="<?php echo get_search_query(); ?>" name="s" placeholder="<?php esc_attr_e( 'Type your search........', 'blenco-core' ); ?>">
	...
	function hfe_render_footer() {
		...
		if ( false == apply_filters( 'blenco_footer_builder_enable', true ) ) {
			return;
		}
		?>
        <footer class="site-footer blenco-footer-builder" role="contentinfo">
