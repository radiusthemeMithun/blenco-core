...
namespace RT\BlencoCore\Abstracts;
...
abstract class ElementorWidgetBase extends Widget_Base {
	...
	public function __construct( $data = [], $args = null ) {
		...
		$this->blenco_category = BLENCO_CORE_PREFIX . '-widgets'; // Category /@dev
		$this->blenco_icon     = 'rdtheme-el-custom';
	}
	...
	protected function register_controls() {
		...
		foreach ( $fields as $id => $field ) {
			$field['classes'] = ! empty( $field['classes'] ) ? $field['classes'] . ' elementor-control-blenco_el' : ' elementor-control-blenco_el';
		...
		do_action( 'blenco/after/register/controls' );
	}
