...
namespace RT\BlencoCore\Modules;
...
class WidgetOverwrite {
	...
	public function __construct() {
		...
		add_action( 'in_widget_form', [ $this, 'blenco_in_widget_form' ], 5,
			3 );
		//Callback function for options update (priorität 5, 3 parameters)
		add_filter( 'widget_update_callback',
			[ $this, 'blenco_in_widget_form_update' ], 5, 3 );
		//add class names (default priority, one parameter)
		add_filter( 'dynamic_sidebar_params',
			[ $this, 'blenco_dynamic_sidebar_params' ] );
	}

	function blenco_in_widget_form( $t, $return, $instance ) {
	...
	function blenco_in_widget_form_update(
	...
	function blenco_dynamic_sidebar_params( $params ) {
