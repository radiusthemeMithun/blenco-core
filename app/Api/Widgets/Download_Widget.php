...
class Download_Widget extends WP_Widget {
	...
	public function __construct() {
		$id    = BLENCO_CORE_PREFIX . '_download';
		$title = __( 'Blenco: Download', 'blenco-core' );
		$args  = [
			'description' => esc_html__( 'Displays Download Info', 'blenco-core' )
		];
	...
	public function form( $instance ) {
		...
		$fields = [
			...
			'down_title'       => [
				'label'   => esc_html__( 'Download Title', 'blenco-core' ),
				'type'    => 'text',
			],
			'down_url'    => [
				'label'    => esc_html__( 'Download URL', 'blenco-core' ),
				'type'     => 'url',
			],
			'doc_title'       => [
				'label'   => esc_html__( 'Document Title', 'blenco-core' ),
				'type'    => 'text',
			],
			'doc_url'    => [
				'label'    => esc_html__( 'Document URL', 'blenco-core' ),
				'type'     => 'url',
			],
		];
