...
class Contact_Widget extends WP_Widget {
	...
	public function __construct() {
		$id    = BLENCO_CORE_PREFIX . '_contact';
		$title = __( 'Blenco: Contact', 'blenco-core' );
		$args  = [
			'description' => esc_html__( 'Displays Contact Info', 'blenco-core' )
		];
	...
	public function form( $instance ) {
		$defaults = [
			'address' => blenco_option( 'rt_contact_address' ),
			'mail'    => blenco_option( 'rt_email' ),
			'phone'   => blenco_option( 'rt_phone' ),
			'website' => blenco_option( 'rt_website' ),
			'logo'        => '',
			'facebook'    => '',
			'twitter'     => '',
			'linkedin'    => '',
		...
		$fields = [
			...
			'address' => [
				'label' => esc_html__( 'Address', 'blenco-core' ),
				'type'  => 'textarea',
			],
			'mail'    => [
				'label' => esc_html__( 'Mail', 'blenco-core' ),
				'type'  => 'text',
			],
			'phone'   => [
			...
			'website' => [
				'label' => esc_html__( 'Website', 'blenco-core' ),
				'type'  => 'text',
			],
			'facebook'    => [
	...
	public function widget( $args, $instance ) {
		...
		// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		echo blenco_contact_render( $instance );
		// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
