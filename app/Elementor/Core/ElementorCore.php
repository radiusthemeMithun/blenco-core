...
namespace RT\BlencoCore\Elementor\Core;
...
class ElementorCore {
	...
	public function get_bg_controlls( $element ) {
			...
			$element->add_control(
				...
				[
					'label'        => __( 'Parallax Transition off?', 'blenco-core' ),
					'type'         => \Elementor\Controls_Manager::SWITCHER,
					'label_off'    => __( 'on', 'blenco-core' ),
					'label_on'     => __( 'Off', 'blenco-core' ),
					'default'      => 'off',
					'return_value' => 'off',
