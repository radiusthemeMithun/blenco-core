...
class ProjectFun extends ElementorBase {

	public function __construct($data = [], $args = null) {
		$this->rt_name = esc_html__('RT Project Fun', 'blenco-core');
		$this->rt_base = 'rt-project-fun';
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'title', [
				...
				'default' => esc_html__( 'Creative Marketing' , 'blenco-core' ),
				'label_block' => true,
			]
		);
		...
		$repeater->add_control(
			'image', [
				...
				'description' => esc_html__( 'Recommended full image', 'blenco-core' ),
				'label_block' => true,
			]
		);
        $repeater->add_control(
        ...
        $repeater->add_control(
			...
			[
				...
				'default'     => __( 'Brand Strategy','blenco-core'),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			'project_scroll_animation',
			[
				'label'        => __( 'Scale Animation Display', 'blenco-core' ),
        ...
        $this->add_control(
			'items',
			[
				'label' => __('Project List', 'blenco-core'),
				'type' => \Elementor\Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'title' => __('Creating Engaging Social Media', 'blenco-core'),
						'content' => __('our Creative Digital Agen  we bring gagingDigital Agenclife beach craftingo reative e bring engaging Digital.', 'blenco-core'),
					],
					[
						'title' => __('Creating Engaging Social Media', 'blenco-core'),
						'content' => __('our Creative Digital Agen  we bring gagingDigital Agenclife beach craftingo reative e bring engaging Digital.', 'blenco-core'),
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .rt-project-fun .fun-title',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .rt-project-fun .fun-title'   => 'color: {{VALUE}}',
					'{{WRAPPER}} .rt-project-fun .fun-title a' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .rt-project-fun .fun-title a:hover' => 'color: {{VALUE}} !important',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .rt-project-fun .fun-title' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();
		...
		$this->add_group_control(
			...
			[
				'name'     => 'category_typo',
				'label'    => esc_html__( 'Typo', 'blenco-core' ),
				'selector' => '{{WRAPPER}} .rt-project-fun .project-cat',
			]
		);
		$this->add_control(
			'category_color',
			[
				...
				'label'     => esc_html__( 'Color', 'blenco-core' ),
				'selectors' => [
					'{{WRAPPER}} .rt-project-fun .project-cat' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .rt-project-fun .project-cat' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name'     => 'content_typo',
				'label'    => esc_html__( 'Typo', 'blenco-core' ),
				'selector' => '{{WRAPPER}} .rt-project-fun .rt-content',
			]
		);
		$this->add_control(
			'content_color',
			[
				...
				'label'     => esc_html__( 'Color', 'blenco-core' ),
				'selectors' => [
					'{{WRAPPER}} .rt-project-fun .rt-content' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .rt-project-fun .rt-content' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .rt-project-fun .project-thumbs img' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .rt-project-fun .project-thumbs img' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .rt-project-fun .project-thumbs' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
					'{{WRAPPER}} .rt-project-fun .project-thumbs img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				],
			]
		);
		$this->add_group_control(
			...
			[
				'name' => 'image_border',
				'selector' => '{{WRAPPER}} .rt-project-fun .project-thumbs',
			]
		);
		$this->add_group_control(
			...
			[
				...
				'label' => __('Image Shadow', 'blenco-core'),
				'selector' => '{{WRAPPER}} .rt-project-fun .project-thumbs',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'type'    => Controls_Manager::SLIDER,
				'mode'          => 'responsive',
				'label'   => esc_html__( 'Icon Width', 'blenco-core' ),
				'size_units' => [ '%', 'px' ],
				'range' => [
					'%' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			...
			[
				'type'    => Controls_Manager::SLIDER,
				'mode'          => 'responsive',
				'label'   => esc_html__( 'Icon Height', 'blenco-core' ),
				'size_units' => [ '%', 'px' ],
				'range' => [
					'%' => [
						'min' => 0,
        ...
        $this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .rt-button .btn .btn-icon',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .rt-project-fun .fun-content' => 'background-color: {{VALUE}}',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units'         => [ 'px' ],
				'selectors'          => [
					'{{WRAPPER}} .rt-project-fun .fun-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				],
				'separator' => 'before',
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units'         => [ 'px' ],
				'selectors'          => [
					'{{WRAPPER}} .rt-project-fun .fun-content' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				],
				'separator' => 'before',
			]
		);
		$this->add_group_control(
			...
			[
				'name' => 'box_border',
				'selector' => '{{WRAPPER}} .rt-project-fun .fun-content',
			]
		);
	...
	protected function render() {
		...
		$template = 'view-1';
		Fns::get_template( "elementor/project-fun/$template", $data );
	}
}